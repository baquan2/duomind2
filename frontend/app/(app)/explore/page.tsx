      ...
      <div className="grid gap-5 xl:grid-cols-[1.25fr_0.75fr]">
        <Card className="border border-border/70 bg-card/92">
          ...
          <CardContent className="space-y-5">
            <Textarea
              placeholder="Ví dụ: AI là gì? | Lịch sử Việt Nam nên học như thế nào? | Giải thích lạm phát cho người mới bắt đầu"
              value={prompt}
            ...
            <Card key={label} className="border border-border/70 bg-card/92">
              <CardContent className="space-y-3 p-5">
                ...
                <p className="text-sm leading-6 text-muted-foreground">
                  Hệ thống đang xử lý bước này bằng Gemini và lưu kết quả vào session hiện tại.
                </p>
              </CardContent>
            </Card>
          ))}
